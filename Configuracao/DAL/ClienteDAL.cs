...
namespace DAL
{
    public class ClienteDAL
    {
        ...
        public Cliente BuscarPorId(int _id)
        {
            ...
            {
                throw new Exception("Ocorreu um erro ao tentar buscar clientes por nome no banco de dados.", ex) { Data = { { "Id", 18 } } };
            }
            finally
            {
                cn.Close();
        ...
        public void Alterar(Cliente _cliente)
        {
            ...
            {
                throw new Exception("Ocorreu um erro ao tentar alterar os dados de um cliente no banco de dados", ex) { Data = { { "Id", 20 } } };
            }
            finally
            {
                cn.Close();
